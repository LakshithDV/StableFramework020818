...
public class frontEnd extends WebBasePage {
    ...
    public void contactTab(Map<String, String> data){
        ...
        clickElementVisible(By.xpath("//div[@id='contactus-content']//a[@class='cls-btn']"),"Click Cancel button",10);
        staticWait(2000);

    }

    public void proventested(){

       /* // we use this code to move the mouse cursor on image.
        moveToElement(By.id("first_myntra"),"Mouse over on myntra",10);
        staticWait(3000);
        moveToElement(By.xpath("//a[@id='first_zoomcar']"),"Mouse over on zoomcar",10);
        staticWait(3000);
        moveToElement(By.xpath("//a[@id='first_caratlane']"),"Mouse over on caratlane",10);
        staticWait(3000);
        moveToElement(By.xpath("//a[@id='first_cleartrip']"),"Mouse over on cleartrip",10);
        staticWait(5000);*/
