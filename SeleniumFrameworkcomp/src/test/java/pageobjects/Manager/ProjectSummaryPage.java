 ...
 *
 */
public class ProjectSummaryPage extends WebBasePage {
    ...
    public void uploadSample(){
        ...
        String filename=System.getProperty("user.dir")+"//src//main//resources//uploadfiles//sample96.doc";
    ...
    public void uploadData(){
        ...
        String filename=System.getProperty("user.dir")+"//src//main//resources//uploadfiles//Dtat contain 4 element .xlsx";
    ...
    public void searchWritter(Map<String,String> data){
        ...
        //clickElementVisible(By.xpath("//label[contains(text(),'Laksh dv')]"),"Laksh dv",10);    my code
           clickElementVisible(By.xpath("//input[@id='writer_search_1069'][@name='writer_search_ids[]']"),"Laksh dv",10);
    }
